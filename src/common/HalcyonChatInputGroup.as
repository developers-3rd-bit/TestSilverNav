package common
{
   ...
   public class HalcyonChatInputGroup extends McChatInputGroup
   {
      ...
      private function onChatInputEnter(event:KeyboardEvent):void {
         ...
         var halcyonEvent:UiEvent = new UiEvent(NEW_CHAT_MESSAGE);
         halcyonEvent.object = strMessage;
         _tfChatInput.text = "";
      ...
      private function onMcShowTimeStampsBtnClick(event:Event):void {
         ...
         var halcyonEvent:UiEvent = new UiEvent(TIMESTAMP_BTN_CLICK);
         halcyonEvent.object = _showTimeStamp;
         dispatchEvent(halcyonEvent);
      }
